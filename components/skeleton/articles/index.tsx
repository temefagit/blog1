...
<<<<<<< HEAD
    <div className="bg-white flex rounded-lg shadow-md font-roboto">
      <div className="flex flex-col pl-6 p-4">
        <div className="h-3 bg-gray-200 rounded-full dark:bg-gray-700 flex flex-row pb-4 text-sm font-bold"></div>
=======
<<<<<<< Updated upstream
    <div className={`${style.articleSection}`}>
      <div className={`${style.articlesItems}`}>
        <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 w-48 mb-4"></div>
>>>>>>> feature-skeletonArticle
        <svg
          className="w-80 h-40 py-10 text-gray-200 dark:text-gray-600"
          aria-hidden="true"
...
<<<<<<< HEAD
        <div>
          <div className="h-1 mt:w-20 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 py-2"></div>
          <div className="h-1 mt:w-60 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 py-2"></div>
          <div className="h-1 mt:w-60 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 py-2"></div>
          <div className="h-1 mt:w-60 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 py-2"></div>
          <div className="h-1 mt:w-60 bg-gray-200 rounded-full dark:bg-gray-700 mb-2.5 py-2"></div>
        </div>
